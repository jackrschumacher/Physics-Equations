public class Physics {
   ...
   * final position = initial position position + the product of initial speed +
   * product of 1/2 and acceration and time squared
   */

  /*
   * Position after a constant acceleration
   * using the above information, we know all of the information except final
   * position
  ...
  public static double distanceAfterProjectileAtAnAngle(double theta, double speed) {
    ...
    // Calculates the total horizontal distance based on xSpeed and how long the
    // ball flies.
  ...
  /**
   * This method calculates flight time of an object traveling vertically and
   * effected by gravity
   * Precondition : initial speed (up is positive)
   * Postcondition: time is returned as twice the amount of time taken to reach
   * the apex
   */
